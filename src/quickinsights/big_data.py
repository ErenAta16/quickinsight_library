...
def estimate_memory_usage(df: pd.DataFrame) -> Dict[str, float]:
    ...
    memory_info['savings_percent'] = (memory_info['savings_mb'] / memory_info['current_mb']) * 100
...
def check_memory_constraints(
    ...
    return {
        ...
        'recommendation': 'Use chunked processing' if estimated_memory_mb > max_allowed_mb else 'Safe to process'
    }
